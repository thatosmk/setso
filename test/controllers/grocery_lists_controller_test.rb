...
class GroceryListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery_list" do
    assert_difference('GroceryList.count') do
      post grocery_lists_url, params: { grocery_list: { name: @grocery_list.name, total_amount: @grocery_list.total_amount } }
    end
  ...
  test "should update grocery_list" do
    patch grocery_list_url(@grocery_list), params: { grocery_list: { name: @grocery_list.name, total_amount: @grocery_list.total_amount } }
